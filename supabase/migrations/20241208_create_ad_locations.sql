...
('homepage_banner', 'Homepage Banner', 'Large banner at the top of the homepage', 'homepage', 'banner', true, 150.00, '1200x300'),
('homepage_sidebar', 'Homepage Sidebar', 'Sidebar banner on the homepage', 'homepage', 'sidebar', false, 75.00, '300x250'),
('articles_banner', 'Articles Page Banner', 'Banner at the top of articles listing page', 'articles', 'banner', true, 120.00, '1200x300'),
('articles_sidebar', 'Articles Sidebar', 'Sidebar in articles listing page', 'articles', 'sidebar', false, 60.00, '300x250'),
('article_in_article', 'In-Article Ad', 'Advertisement within article content', 'article', 'in-article', true, 100.00, '728x90'),
('article_popup', 'Article Popup Ad', 'Popup advertisement on article pages', 'article', 'popup', true, 80.00, '500x500'),
('article_sidebar', 'Article Sidebar', 'Sidebar on individual article pages', 'article', 'sidebar', false, 50.00, '300x250'),
('anonymous_stories_banner', 'Anonymous Stories Banner', 'Banner on anonymous stories page', 'anonymous_stories', 'banner', false, 40.00, '1200x300'),
('sponsored_content', 'Sponsored Content', 'Sponsored article placement on homepage', 'homepage', 'sponsored', true, 200.00, 'Variable'),
('custom_placement', 'Custom Placement', 'Custom ad placement as requested', 'custom', 'other', true, 0.00, 'Variable')
